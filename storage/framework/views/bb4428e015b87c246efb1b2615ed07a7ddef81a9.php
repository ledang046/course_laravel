        ...
        <div class="card-header">
            <div class="row">
                ...
                <div class="col-md-2 text-right">
                    <a class="btn-add py-1 px-3" href="<?php echo e(route('categories.create')); ?>">
            ...
            <table class="table ">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <form style="display: inline;" action="<?php echo e(url('admin/categories/'.$rows->id)); ?>" method="POST" onsubmit="return confirm('Are you sure you want to delete?');" >
                                <?php echo csrf_field(); ?>
                                <?php echo method_field('DELETE'); ?>
                                <a class="badge badge-complete" style="color:white;" href="<?php echo e(url('admin/categories/'.$rows->id)); ?>">
                                    <i class="fas fa-bars"></i>
                                </a>
                                <a class="badge badge-complete" style="color:white;" href="<?php echo e(url('admin/categories/'.$rows->id.'/edit')); ?>">
...
<?php echo $__env->make("layouts.layout", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\course_laravel\resources\views/backend/category_read.blade.php ENDPATH**/ ?>